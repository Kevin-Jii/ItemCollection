(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global["vue3-photo-preview"] = {}, global.Vue));
  ...
  const _hoisted_2$9 = /*#__PURE__*/vue.createElementVNode("svg", {
    ...
    /*#__PURE__*/vue.createElementVNode("path", { d: "M16 0 A16 16 0 0 1 32 16 L28 16 A12 12 0 0 0 16 4z" })
  ], -1 /* HOISTED */);
  const _hoisted_3$9 = [
    _hoisted_2$9
  ];
  ...
  function render$c(_ctx, _cache, $props, $setup, $data, $options) {
    return (vue.openBlock(), vue.createElementBlock("div", _hoisted_1$a, _hoisted_3$9))
  }
  ...
  function useLoadImage(src) {
      var naturalWidth = vue.ref(0);
      var naturalHeight = vue.ref(0);
      var width = vue.ref(0);
  ...
  // 动画类型
  exports.ShowAnimateEnum = void 0;
  ...
  })(exports.ShowAnimateEnum || (exports.ShowAnimateEnum = {}));
  // 触摸状态
  exports.TouchTypeEnum = void 0;
  ...
  })(exports.TouchTypeEnum || (exports.TouchTypeEnum = {}));
  // 边缘状态
  exports.EdgeTypeEnum = void 0;
  ...
  })(exports.EdgeTypeEnum || (exports.EdgeTypeEnum = {}));
  ...
  function getEdgeTypes(_a) {
      ...
      if (x === position.edgeLeft) {
          edgeTypes.push(exports.EdgeTypeEnum.Left);
      }
      if (x === position.edgeRight) {
          edgeTypes.push(exports.EdgeTypeEnum.Right);
      }
      if (y === position.edgeTop) {
          edgeTypes.push(exports.EdgeTypeEnum.Top);
      }
      if (y === position.edgeBottom) {
          edgeTypes.push(exports.EdgeTypeEnum.Bottom);
      }
      return edgeTypes;
  }
  /**
  ...
  function useMoveImage(width, height, naturalWidth, naturalHeight, setSuitableImageSize, onTouchStart, onTouchMove, onTouchEnd, onSingleTap) {
      ...
      // 触摸开始时 x 的坐标
      var clientX = vue.ref(0);
      // 触摸开始时 y 的坐标
      var clientY = vue.ref(0);
      // 初始触摸状态
      var touchType = vue.ref(exports.TouchTypeEnum.Normal);
      // 上一次图片的 x 偏移量
      var lastX = vue.ref(0);
      // 上一次图片的 y 偏移量
      var lastY = vue.ref(0);
      // 上一次 touch 的长度
      var lastTouchLength = vue.ref(0);
      // 上一次的图片缩放程度
      var lastScale = vue.ref(1);
      // 边缘状态(用于缩放图片判断)
      var edgeTypes = [];
      ...
      var handleMove = throttle(function (newClientX, newClientY, touchLength) {
          // 初始化触摸状态
          if (touchType.value === exports.TouchTypeEnum.Normal) {
              if (scale.value !== 1 || touchLength) {
                  touchType.value = exports.TouchTypeEnum.Scale;
              }
              else {
                  ...
                  if (!isMoveX && !isMoveY)
                      return;
                  // 水平方向优先
                  touchType.value = isMoveX ? exports.TouchTypeEnum.X : exports.TouchTypeEnum.Y;
              }
          }
          ...
          if (touchType.value === exports.TouchTypeEnum.Y) {
              x.value = newX + lastX.value;
              y.value = newY + lastY.value;
          }
          if (touchType.value === exports.TouchTypeEnum.Scale) {
              if (touchLength) {
                  ...
                  if (!(newX > 0 && edgeTypes.includes(exports.EdgeTypeEnum.Left)) &&
                      !(newX < 0 && edgeTypes.includes(exports.EdgeTypeEnum.Right))) {
                      x.value = newX + lastX.value;
                  }
                  y.value = newY + lastY.value;
              }
      ...
      var handleUp = function (newClientX, newClientY, e) {
          ...
          touched.value = false;
          touchType.value = exports.TouchTypeEnum.Normal;
          clientX.value = 0;
          clientY.value = 0;
          lastX.value = x.value;
          lastY.value = y.value;
  ...
  var script$b = vue.defineComponent({
      ...
      data: function () {
          return {
              ShowAnimateEnum: exports.ShowAnimateEnum,
              // 翻转
      ...
      ? (vue.openBlock(), vue.createElementBlock("div", {
        ...
        height: `${_ctx.height}px`
          ...
          vue.createElementVNode("div", {
            class: vue.normalizeClass(["PhotoView__PhotoBox", {
          ...
          width: _ctx.showAnimateType === _ctx.ShowAnimateEnum.In || _ctx.showAnimateType === _ctx.ShowAnimateEnum.Out ? '0' : '100%'
            ...
            transition: _ctx.touched ? undefined : 'transform 0.5s cubic-bezier(0.25, 0.8, 0.25, 1)',
              ...
              onMousedown: _cache[0] || (_cache[0] = vue.withModifiers((...args) => (_ctx.handleMouseDown && _ctx.handleMouseDown(...args)), ["prevent"])),
              onTouchstart: _cache[1] || (_cache[1] = vue.withModifiers((...args) => (_ctx.handleTouchStart && _ctx.handleTouchStart(...args)), ["prevent"])),
              onWheel: _cache[2] || (_cache[2] = (...args) => (_ctx.handleWheel && _ctx.handleWheel(...args)))
            }, null, 44 /* STYLE, PROPS, HYDRATE_EVENTS */, _hoisted_1$9)
          ], 6 /* CLASS, STYLE */)
        ], 4 /* STYLE */))
      : (vue.openBlock(), vue.createBlock(_component_spinner, { key: 1 }))
  }
  ...
  function useInnerWidth() {
      var innerWidth = vue.ref(window.innerWidth);
      var handleResize = throttle(function () {
  ...
  const _hoisted_2$7 = /*#__PURE__*/vue.createElementVNode("path", { d: "M640.5 352.5v63h-390l178.5 180-45 45-256.5-256.5 256.5-256.5 45 45-178.5 180h390z" }, null, -1 /* HOISTED */);
  const _hoisted_3$7 = [
    _hoisted_2$7
  ];
  ...
  const _hoisted_2$6 = /*#__PURE__*/vue.createElementVNode("path", { d: "M384 127.5l256.5 256.5-256.5 256.5-45-45 178.5-180h-390v-63h390l-178.5-180z" }, null, -1 /* HOISTED */);
  const _hoisted_3$6 = [
    _hoisted_2$6
  ];
  ...
  function render$3(_ctx, _cache, $props, $setup, $data, $options) {
    return (vue.openBlock(), vue.createElementBlock("svg", _hoisted_1$1, _hoisted_6))
  }
  ...
  function useAnimationHandle(visible, currentItem) {
      var photoVisible = vue.ref(visible.value);
      var showAnimateType = vue.ref(exports.ShowAnimateEnum.None);
      var originRect = vue.ref(null);
      vue.watch(visible, function () {
          ...
          if (visible.value) {
              // 设置动画类型
              showAnimateType.value = exports.ShowAnimateEnum.In;
              // 显示图片
              photoVisible.value = true;
          }
          else {
              // 设置动画类型
              showAnimateType.value = exports.ShowAnimateEnum.Out;
          }
      });
      // 动画结束的回调
      var onShowAnimateEnd = function () {
          // 动画完成才关闭弹窗
          if (showAnimateType.value === exports.ShowAnimateEnum.Out) {
              photoVisible.value = false;
          }
          showAnimateType.value = exports.ShowAnimateEnum.None;
      };
      return {
  ...
  var script$2 = vue.defineComponent({
      ...
      methods: {
          ...
          setPhotoViewRef: function (key, ref) {
          ...
          handleTouchMove: function (touchType, clientX, clientY, lastScale, edgeTypes) {
              if (touchType === exports.TouchTypeEnum.Scale && lastScale !== 1) {
                  this.handleTouchScaleMove(clientX, edgeTypes);
              }
              if (touchType === exports.TouchTypeEnum.X) {
                  this.handleTouchHorizontalMove(clientX);
              }
              if (touchType === exports.TouchTypeEnum.Y) {
          ...
          handleTouchScaleMove: function (clientX, edgeTypes) {
              ...
              if ((touchMoveX > 0 && edgeTypes.includes(exports.EdgeTypeEnum.Left)) ||
                  (touchMoveX < 0 && edgeTypes.includes(exports.EdgeTypeEnum.Right))) {
                  this.handleTouchHorizontalMove(clientX);
              }
          },
          ...
          handleTouchScaleEnd: function (clientX, edgeTypes) {
              ...
              // 下一张
              if (offsetX < -minSwitchImageOffset && edgeTypes.includes(exports.EdgeTypeEnum.Right)) {
                  this.handleNext();
              }
              // 上一张
              if (offsetX > minSwitchImageOffset && edgeTypes.includes(exports.EdgeTypeEnum.Left)) {
                  this.handlePrevious();
              }
          },
          ...
          getItemLeft: function (currentIndex) {
              var index = this.virtualIndex + currentIndex;
              // 非循环模式的第一张图片不需要左移，因为只有两张图片，左侧没有图片
              if (this.loop || this.index !== 0) {
                  index -= 1;
              }
              return "".concat((this.innerWidth + this.horizontalOffset) * index, "px");
          },
  ...
  function render$2(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    const _component_rotate_left = vue.resolveComponent("rotate-left");
    const _component_rotate_right = vue.resolveComponent("rotate-right");
    const _component_flip_horizontal = vue.resolveComponent("flip-horizontal");
    const _component_flip_vertical = vue.resolveComponent("flip-vertical");
    const _component_close = vue.resolveComponent("close");
    const _component_photo_view = vue.resolveComponent("photo-view");
        ...
        ? (vue.openBlock(), vue.createElementBlock("div", {
          ...
          'PhotoSlider__Hide': !_ctx.overlayVisible,
            ...
            vue.createElementVNode("div", _hoisted_1, [
              vue.createElementVNode("div", _hoisted_2, vue.toDisplayString(_ctx.index + 1) + " / " + vue.toDisplayString(_ctx.items.length), 1 /* TEXT */),
              vue.createElementVNode("div", _hoisted_3, [
                vue.createVNode(_component_download, {
                  class: "PhotoSlider__BannerIcon",
                  onClick: _ctx.handleDownload
                }, null, 8 /* PROPS */, ["onClick"]),
                vue.createVNode(_component_rotate_left, {
                  class: "PhotoSlider__BannerIcon",
                  onClick: _ctx.handleRotateLeft
                }, null, 8 /* PROPS */, ["onClick"]),
                vue.createVNode(_component_rotate_right, {
                  class: "PhotoSlider__BannerIcon",
                  onClick: _ctx.handleRotateRight
                }, null, 8 /* PROPS */, ["onClick"]),
                vue.createVNode(_component_flip_horizontal, {
                  class: "PhotoSlider__BannerIcon",
                  onClick: _ctx.toggleFlipHorizontal
                }, null, 8 /* PROPS */, ["onClick"]),
                vue.createVNode(_component_flip_vertical, {
                  class: "PhotoSlider__BannerIcon",
            ...
            (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.showItems, (item, currentIndex) => {
            ...
            transform: _ctx.getItemTransform()
                ...
                vue.createVNode(_component_photo_view, {
                  ref_for: true,
                ...
                }, null, 8 /* PROPS */, ["origin-rect", "show-animate-type", "src", "onTouchStart", "onTouchMove", "onTouchEnd", "onSingleTap"])
              ], 36 /* STYLE, HYDRATE_EVENTS */))
            }), 128 /* KEYED_FRAGMENT */)),
            (!_ctx.isTouchDevice)
              ? (vue.openBlock(), vue.createElementBlock(vue.Fragment, { key: 0 }, [
                  (_ctx.loop || _ctx.index > 0)
                    ? (vue.openBlock(), vue.createElementBlock("div", {
                        key: 0,
                  ...
                  (_ctx.loop || _ctx.index < _ctx.items.length - 1)
                    ? (vue.openBlock(), vue.createElementBlock("div", {
                        key: 1,
            ...
            (_ctx.currentItem.intro)
              ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_4, vue.toDisplayString(_ctx.currentItem.intro), 1 /* TEXT */))
              : vue.createCommentVNode("v-if", true)
          ], 2 /* CLASS */))
        : vue.createCommentVNode("v-if", true)
    ]))
  ...
  var script$1 = vue.defineComponent({
      ...
      setup: function (_props, _a) {
          ...
          vue.provide(updateItemKey, updateItem);
          vue.provide(removeItemKey, removeItem);
          vue.provide(handleShowKey, handleShow);
          return {
              items: items,
              updateItem: updateItem,
              removeItem: removeItem,
  ...
  function render$1(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_photo_slider = vue.resolveComponent("photo-slider");

    return (vue.openBlock(), vue.createElementBlock(vue.Fragment, null, [
      vue.createCommentVNode(" @slot 默认插槽 "),
      vue.renderSlot(_ctx.$slots, "default"),
      vue.createVNode(_component_photo_slider, {
      ...
      }, null, 8 /* PROPS */, ["visible", "index", "should-transition", "toggle-overlay", "default-backdrop-opacity", "items", "loop", "download-method", "onClickPhoto", "onClickMask", "onChangeIndex", "onCloseModal"])
    ], 64 /* STABLE_FRAGMENT */))
  }
  ...
  var script = vue.defineComponent({
      ...
      setup: function (props) {
          var updateItem = vue.inject(updateItemKey);
          var removeItem = vue.inject(removeItemKey);
          var handleShow = vue.inject(handleShowKey);
          var root = vue.ref(null);
          var key = uniqueId();
          var _a = vue.toRefs(props), src = _a.src, intro = _a.intro, downloadName = _a.downloadName;
          ...
          vue.watch([src, intro, downloadName], function () {
  ...
  exports.PhotoConsumer = script;
  exports.PhotoProvider = script$1;
  exports.PhotoSlider = script$2;
  exports["default"] = index;

  Object.defineProperty(exports, '__esModule', { value: true });

}));
//# sourceMappingURL=vue3-photo-preview.umd.js.map
