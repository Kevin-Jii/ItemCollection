    ...
    (_ctx.photoVisible)
      ? (openBlock(), createElementBlock("div", {
        ...
        'PhotoSlider__Hide': !_ctx.overlayVisible,
          ...
          (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.showItems, (item, currentIndex) => {
